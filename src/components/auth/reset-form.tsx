    ...
    return (
        <div className="space-y-6">
            <div className="text-center mb-8">
                ...
                <p className="text-zinc-400 text-sm">Digite seu e-mail para receber um link de redefinição</p>
            </div>
            ...
            <div className="text-center">
                <Link href="/auth/signin" className="inline-flex items-center gap-2 text-zinc-500 hover:text-white transition-colors text-sm">
