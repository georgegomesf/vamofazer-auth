    ...
    if (success) {
        return (
            <div className="text-center space-y-6 py-8">
                ...
                <h2 className="text-2xl font-bold text-zinc-950">Pronto!</h2>
                <p className="text-zinc-500">Sua senha foi atualizada com sucesso. Você será redirecionado para a tela de login em instantes.</p>
                <Link href="/auth/signin" className="inline-block text-blue-600 hover:underline font-medium">Ir para o login agora</Link>
            </div>
        );
    }
    ...
    return (
        <div className="space-y-6">
            <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-tr from-emerald-600 to-teal-600 rounded-2xl shadow-lg shadow-emerald-500/20 mb-6 font-bold">
            ...
            <form onSubmit={handleUpdate} className="space-y-5">
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-zinc-600 ml-1">Nova Senha</label>
                ...
                <div className="space-y-2">
                    <label className="text-sm font-medium text-zinc-600 ml-1">Confirmar Nova Senha</label>
                    <div className="relative group">
                        <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-zinc-400 group-focus-within:text-emerald-500 transition-colors" />
                        <input
                            type="password"
